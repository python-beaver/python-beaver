...
def parse_args():
    ...
    parser.add_argument('-t', '--transport', help='log transport method', dest='transport', default=None, choices=['kafka', 'mqtt', 'rabbitmq', 'redis', 'sqs', 'kinesis', 'stdout', 'tcp', 'udp', 'zmq', 'http'])
...
def include_filter_line(lines, include_filter_regex):
    ...
    for line in lines:
      ...
      if include_filter_regex:
          ...
          for pattern in include_filter_regex:
